...
summary$about <- "For our project, our domain of interest is to observe
...
summary$purpose <- "As college entrance exams, such as the SAT or ACT, were
...
summary$research <- "The source of the data is from
California Department Of Education and ACS
2010 - 2014 ACS Data."
